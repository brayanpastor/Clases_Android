package com.brayanpastor.recetario;
...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mFragmet.addTab(mFragmet.newTabSpec("tag2").setIndicator(("Categorias"),
                getResources().getDrawable(android.R.drawable.ic_popup_sync)),
                CategoriasFragment.class, null);

		mFragmet.addTab(mFragmet.newTabSpec("tag3").setIndicator(("Platos"),
                getResources().getDrawable(android.R.drawable.ic_popup_sync)),
